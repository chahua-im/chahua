 ...
 */
import type { ListServiceTokensResponse } from '../../models';
 ...
 */
export function getServiceTokensResource(
  options: OrvalHttpResourceOptions<ListServiceTokensResponse, unknown> & {
    defaultValue: NoInfer<ListServiceTokensResponse>;
  },
): HttpResourceRef<ListServiceTokensResponse>;
export function getServiceTokensResource(
  options?: OrvalHttpResourceOptions<ListServiceTokensResponse, unknown>,
): HttpResourceRef<ListServiceTokensResponse | undefined>;
export function getServiceTokensResource(
  options?: OrvalHttpResourceOptions<ListServiceTokensResponse, unknown>,
): HttpResourceRef<ListServiceTokensResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<ListServiceTokensResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/service-tokens`, options),
    options,
  );
}

export type GetServiceTokensResourceResult = NonNullable<ListServiceTokensResponse>;
