 ...
 */
export function getSessionGenerationResource(
  uid: Signal<number>,
  options: OrvalHttpResourceOptions<SessionGenerationResponse, unknown> & {
    defaultValue: NoInfer<SessionGenerationResponse>;
  },
): HttpResourceRef<SessionGenerationResponse>;
export function getSessionGenerationResource(
  uid: Signal<number>,
  options?: OrvalHttpResourceOptions<SessionGenerationResponse, unknown>,
): HttpResourceRef<SessionGenerationResponse | undefined>;
export function getSessionGenerationResource(
  uid: Signal<number>,
  options?: OrvalHttpResourceOptions<SessionGenerationResponse, unknown>,
): HttpResourceRef<SessionGenerationResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<SessionGenerationResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/external/sessions/${uid()}`, options),
    options,
  );
}

export type GetSessionGenerationResourceResult = NonNullable<SessionGenerationResponse>;
