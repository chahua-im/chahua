 ...
 */
import type { GetMembersParams, ListMembersResponse, SnowflakeID } from '../../models';
 ...
 */
export function getMembersResource(
  chatId: Signal<SnowflakeID>,
  params: Signal<GetMembersParams> | undefined,
  options: OrvalHttpResourceOptions<ListMembersResponse, unknown> & {
    defaultValue: NoInfer<ListMembersResponse>;
  },
): HttpResourceRef<ListMembersResponse>;
export function getMembersResource(
  chatId: Signal<SnowflakeID>,
  params?: Signal<GetMembersParams>,
  options?: OrvalHttpResourceOptions<ListMembersResponse, unknown>,
): HttpResourceRef<ListMembersResponse | undefined>;
export function getMembersResource(
  chatId: Signal<SnowflakeID>,
  params?: Signal<GetMembersParams>,
  options?: OrvalHttpResourceOptions<ListMembersResponse, unknown>,
  ...
  return httpResource<ListMembersResponse>(() => {
    const request = {
      url: `${baseUrl}/group/${decodeId(chatId())}/members`,
      params: filterParams(params?.() ?? {}, new Set<string>([])),
    };
    return applyOrvalRequestExtension(request, options);
  }, options);
}
export type GetMembersResourceResult = NonNullable<ListMembersResponse>;
/**
