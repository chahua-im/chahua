 ...
 */
import type { AttachmentConfigResponse } from '../../models';
...
export function getConfigResource(
  options: OrvalHttpResourceOptions<AttachmentConfigResponse, unknown> & {
    defaultValue: NoInfer<AttachmentConfigResponse>;
  },
): HttpResourceRef<AttachmentConfigResponse>;
export function getConfigResource(
  options?: OrvalHttpResourceOptions<AttachmentConfigResponse, unknown>,
): HttpResourceRef<AttachmentConfigResponse | undefined>;
export function getConfigResource(
  options?: OrvalHttpResourceOptions<AttachmentConfigResponse, unknown>,
): HttpResourceRef<AttachmentConfigResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<AttachmentConfigResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/attachments/config`, options),
    options,
  );
}

export type GetConfigResourceResult = NonNullable<AttachmentConfigResponse>;
