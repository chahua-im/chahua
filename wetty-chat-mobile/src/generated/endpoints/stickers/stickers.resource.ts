 ...
 */
export function getMyFavoritesResource(
  options: OrvalHttpResourceOptions<FavoriteStickerListResponse, unknown> & {
    defaultValue: NoInfer<FavoriteStickerListResponse>;
  },
): HttpResourceRef<FavoriteStickerListResponse>;
export function getMyFavoritesResource(
  options?: OrvalHttpResourceOptions<FavoriteStickerListResponse, unknown>,
): HttpResourceRef<FavoriteStickerListResponse | undefined>;
export function getMyFavoritesResource(
  options?: OrvalHttpResourceOptions<FavoriteStickerListResponse, unknown>,
): HttpResourceRef<FavoriteStickerListResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<FavoriteStickerListResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/stickers/mine/favorites`, options),
    options,
  );
}
/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getMyOwnedPacksResource(
  options: OrvalHttpResourceOptions<StickerPackListResponse, unknown> & {
    defaultValue: NoInfer<StickerPackListResponse>;
  },
): HttpResourceRef<StickerPackListResponse>;
export function getMyOwnedPacksResource(
  options?: OrvalHttpResourceOptions<StickerPackListResponse, unknown>,
): HttpResourceRef<StickerPackListResponse | undefined>;
export function getMyOwnedPacksResource(
  options?: OrvalHttpResourceOptions<StickerPackListResponse, unknown>,
): HttpResourceRef<StickerPackListResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<StickerPackListResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/stickers/packs/mine/owned`, options),
    options,
  );
}
/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getMySubscribedPacksResource(
  options: OrvalHttpResourceOptions<StickerPackListResponse, unknown> & {
    defaultValue: NoInfer<StickerPackListResponse>;
  },
): HttpResourceRef<StickerPackListResponse>;
...
export function getMySubscribedPacksResource(
  ...
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<StickerPackListResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/stickers/packs/mine/subscribed`, options),
    options,
  );
}
/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getPackResource(
  packId: Signal<SnowflakeID>,
  options: OrvalHttpResourceOptions<StickerPackDetailResponse, unknown> & {
    defaultValue: NoInfer<StickerPackDetailResponse>;
  },
): HttpResourceRef<StickerPackDetailResponse>;
export function getPackResource(
  packId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<StickerPackDetailResponse, unknown>,
): HttpResourceRef<StickerPackDetailResponse | undefined>;
export function getPackResource(
  packId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<StickerPackDetailResponse, unknown>,
): HttpResourceRef<StickerPackDetailResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<StickerPackDetailResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/stickers/packs/${decodeId(packId())}`, options),
    options,
  );
}
/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getStickerResource(
  stickerId: Signal<SnowflakeID>,
  options: OrvalHttpResourceOptions<StickerDetailResponse, unknown> & {
    defaultValue: NoInfer<StickerDetailResponse>;
  },
): HttpResourceRef<StickerDetailResponse>;
export function getStickerResource(
  stickerId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<StickerDetailResponse, unknown>,
): HttpResourceRef<StickerDetailResponse | undefined>;
export function getStickerResource(
  stickerId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<StickerDetailResponse, unknown>,
): HttpResourceRef<StickerDetailResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<StickerDetailResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/stickers/${decodeId(stickerId())}`, options),
    options,
  );
}
export type GetMyFavoritesResourceResult = NonNullable<FavoriteStickerListResponse>;
export type GetMyOwnedPacksResourceResult = NonNullable<StickerPackListResponse>;
export type GetMySubscribedPacksResourceResult = NonNullable<StickerPackListResponse>;
export type GetPackResourceResult = NonNullable<StickerPackDetailResponse>;
export type GetStickerResourceResult = NonNullable<StickerDetailResponse>;
/**
