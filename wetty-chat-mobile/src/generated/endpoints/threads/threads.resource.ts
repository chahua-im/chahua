 ...
 */
export function getThreadReadStateInChatResource(
  chatId: Signal<SnowflakeID>,
  threadRootId: Signal<SnowflakeID>,
  options: OrvalHttpResourceOptions<ThreadReadStateResponse, unknown> & {
    defaultValue: NoInfer<ThreadReadStateResponse>;
  },
): HttpResourceRef<ThreadReadStateResponse>;
export function getThreadReadStateInChatResource(
  chatId: Signal<SnowflakeID>,
  threadRootId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<ThreadReadStateResponse, unknown>,
): HttpResourceRef<ThreadReadStateResponse | undefined>;
export function getThreadReadStateInChatResource(
  chatId: Signal<SnowflakeID>,
  threadRootId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<ThreadReadStateResponse, unknown>,
  ...
  return httpResource<ThreadReadStateResponse>(
    () =>
      applyOrvalRequestExtension(
        `${baseUrl}/chats/${decodeId(chatId())}/threads/${decodeId(threadRootId())}/read-state`,
        options,
      ),
    options,
  );
 ...
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getThreadsResource(
  params: Signal<GetThreadsParams> | undefined,
  options: OrvalHttpResourceOptions<ListThreadsResponse, unknown> & {
    defaultValue: NoInfer<ListThreadsResponse>;
  },
): HttpResourceRef<ListThreadsResponse>;
export function getThreadsResource(
  params?: Signal<GetThreadsParams>,
  options?: OrvalHttpResourceOptions<ListThreadsResponse, unknown>,
): HttpResourceRef<ListThreadsResponse | undefined>;
export function getThreadsResource(
  params?: Signal<GetThreadsParams>,
  options?: OrvalHttpResourceOptions<ListThreadsResponse, unknown>,
): HttpResourceRef<ListThreadsResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<ListThreadsResponse>(() => {
    const request = {
      url: `${baseUrl}/threads`,
 ...
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getUnreadThreadCountResource(
  options: OrvalHttpResourceOptions<UnreadThreadCountResponse, unknown> & {
    defaultValue: NoInfer<UnreadThreadCountResponse>;
  },
): HttpResourceRef<UnreadThreadCountResponse>;
export function getUnreadThreadCountResource(
  options?: OrvalHttpResourceOptions<UnreadThreadCountResponse, unknown>,
): HttpResourceRef<UnreadThreadCountResponse | undefined>;
export function getUnreadThreadCountResource(
  options?: OrvalHttpResourceOptions<UnreadThreadCountResponse, unknown>,
): HttpResourceRef<UnreadThreadCountResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<UnreadThreadCountResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/threads/unread`, options),
    options,
  );
}
/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getThreadReadStateResource(
  threadRootId: Signal<SnowflakeID>,
  options: OrvalHttpResourceOptions<ThreadReadStateResponse, unknown> & {
    defaultValue: NoInfer<ThreadReadStateResponse>;
  },
...
export function getThreadReadStateResource(
  ...
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<ThreadReadStateResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/threads/${decodeId(threadRootId())}/read-state`, options),
    options,
  );
}
export type GetThreadReadStateInChatResourceResult = NonNullable<ThreadReadStateResponse>;
export type GetThreadsResourceResult = NonNullable<ListThreadsResponse>;
export type GetUnreadThreadCountResourceResult = NonNullable<UnreadThreadCountResponse>;
export type GetThreadReadStateResourceResult = NonNullable<ThreadReadStateResponse>;
/**
