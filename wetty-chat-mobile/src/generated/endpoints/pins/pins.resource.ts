 ...
 */
import type { ListPinsResponse, SnowflakeID } from '../../models';
 ...
 */
export function listPinsResource(
  chatId: Signal<SnowflakeID>,
  options: OrvalHttpResourceOptions<ListPinsResponse, unknown> & {
    defaultValue: NoInfer<ListPinsResponse>;
  },
): HttpResourceRef<ListPinsResponse>;
export function listPinsResource(
  chatId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<ListPinsResponse, unknown>,
): HttpResourceRef<ListPinsResponse | undefined>;
export function listPinsResource(
  chatId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<ListPinsResponse, unknown>,
): HttpResourceRef<ListPinsResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<ListPinsResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/chats/${decodeId(chatId())}/pins`, options),
    options,
  );
}
/**
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function listThreadPinsResource(
  chatId: Signal<SnowflakeID>,
  ...
  return httpResource<ListPinsResponse>(
    () =>
      applyOrvalRequestExtension(
        `${baseUrl}/chats/${decodeId(chatId())}/threads/${decodeId(threadRootId())}/pins`,
        options,
      ),
    options,
  );
}
export type ListPinsResourceResult = NonNullable<ListPinsResponse>;
export type ListThreadPinsResourceResult = NonNullable<ListPinsResponse>;
/**
