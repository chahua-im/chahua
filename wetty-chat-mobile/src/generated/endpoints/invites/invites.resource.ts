 ...
 */
export function getInvitesResource(
  params: Signal<GetInvitesParams> | undefined,
  options: OrvalHttpResourceOptions<ListInvitesResponse, unknown> & {
    defaultValue: NoInfer<ListInvitesResponse>;
  },
): HttpResourceRef<ListInvitesResponse>;
export function getInvitesResource(
  params?: Signal<GetInvitesParams>,
  options?: OrvalHttpResourceOptions<ListInvitesResponse, unknown>,
): HttpResourceRef<ListInvitesResponse | undefined>;
export function getInvitesResource(
  params?: Signal<GetInvitesParams>,
  options?: OrvalHttpResourceOptions<ListInvitesResponse, unknown>,
): HttpResourceRef<ListInvitesResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<ListInvitesResponse>(() => {
    const request = {
      url: `${baseUrl}/invites`,
 ...
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getInviteByCodeResource(
  params: Signal<GetInviteByCodeParams>,
  options: OrvalHttpResourceOptions<InvitePreviewResponse, unknown> & {
    defaultValue: NoInfer<InvitePreviewResponse>;
  },
): HttpResourceRef<InvitePreviewResponse>;
export function getInviteByCodeResource(
  params: Signal<GetInviteByCodeParams>,
  options?: OrvalHttpResourceOptions<InvitePreviewResponse, unknown>,
): HttpResourceRef<InvitePreviewResponse | undefined>;
export function getInviteByCodeResource(
  params: Signal<GetInviteByCodeParams>,
  options?: OrvalHttpResourceOptions<InvitePreviewResponse, unknown>,
): HttpResourceRef<InvitePreviewResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<InvitePreviewResponse>(() => {
    const request = {
      url: `${baseUrl}/invites/invite`,
      params: filterParams(params?.() ?? {}, new Set<string>([])),
    };
    return applyOrvalRequestExtension(request, options);
  }, options);
 ...
 * @remarks httpResource is available in Angular 19.2 and later.
 */
export function getInviteResource(
  inviteId: Signal<SnowflakeID>,
  options: OrvalHttpResourceOptions<InviteResponse, unknown> & {
    defaultValue: NoInfer<InviteResponse>;
  },
): HttpResourceRef<InviteResponse>;
export function getInviteResource(
  inviteId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<InviteResponse, unknown>,
): HttpResourceRef<InviteResponse | undefined>;
export function getInviteResource(
  inviteId: Signal<SnowflakeID>,
  options?: OrvalHttpResourceOptions<InviteResponse, unknown>,
): HttpResourceRef<InviteResponse | undefined> {
  const baseUrl = options?.injector ? options.injector.get(CHAHUA_BASE_URL) : inject(CHAHUA_BASE_URL);
  return httpResource<InviteResponse>(
    () => applyOrvalRequestExtension(`${baseUrl}/invites/invite/${decodeId(inviteId())}`, options),
    options,
  );
}
export type GetInvitesResourceResult = NonNullable<ListInvitesResponse>;
export type GetInviteByCodeResourceResult = NonNullable<InvitePreviewResponse>;
export type GetInviteResourceResult = NonNullable<InviteResponse>;
/**
